...
echo "  1) Cài vLLM riêng (theo CUDA version trên server):"
echo "       . ${VENV_DIR}/bin/activate"
echo "       pip install vllm"
echo "     (xem https://docs.vllm.ai/en/latest/getting_started/installation.html)"
echo "  2) Copy .env.example → .env và chỉnh."
echo "  3) Test:  ./deploy/start_vllm.sh   và   ./deploy/start_api.sh"
